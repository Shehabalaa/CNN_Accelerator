...
run 25
run 50
force -freeze sim:/Controller/INTR 1 0, 0 {50 ns} -r 150
...
run 25
#Write input
force -freeze sim:/Controller/doneDecomp 1 0, 0 {50 ns} -r 150
force -freeze sim:/Controller/doneDMAImage 1 0, 0 {50 ns} -r 150
run 26
#No force
run 24
run 125
...
run 50
force -freeze sim:/Controller/zeroState 0 0
force -freeze sim:/Controller/doneDecomp 1 0, 0 {0 ns} -r 150
force -freeze sim:/Controller/doneDMAImage 1 0, 0 {0 ns} -r 150
run 100
