...
vsim -gui -sdfnoerror -sdfnowarn -sdfmax /=/media/sf_CNN_Accelerator/CNN/Leonardo/FinalCNNNewDMA/CNNWithRAM.sdf work.cnnwithram -noglitch
...
add wave -position insertpoint  \
sim:/cnnwithram/windowRamDataInBus \
sim:/cnnwithram/windowRamDataOutBus
...
mem load -i /media/sf_CNN_Accelerator/CNN/RAMs/PassedLeo/Conv_S_1L2F5/windowRAM.mem -format mti /cnnwithram/windowRam/ram 
mem load -i /media/sf_CNN_Accelerator/CNN/RAMs/PassedLeo/Conv_S_1L2F5/weightsRAM.mem -format mti /cnnwithram/weightsRam/ram 
...
mai mem save -o /media/sf_CNN_Accelerator/CNN/RAMs/PassedLeo/Conv_S_1L2F5/cnnOutputSDF.mem -f mti -data binary -addr hex -wordsperline 1 /cnnwithram/windowRam/ram
