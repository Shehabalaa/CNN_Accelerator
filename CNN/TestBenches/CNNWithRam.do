...
mem load -i ./CNN/RAMs/Pool_S_1L1F3/windowRAM.mem -format mti /cnnwithram/windowRam/ram
mem load -i ./CNN/RAMs/Pool_S_1L1F3/weightsRAM.mem -format mti /cnnwithram/weightsRam/ram
...
#mem save -o ./CNN/RAMs/Pool_S_1L1F3/cnnOutput.mem -f mti -data binary -addr hex -wordsperline 1 /cnnwithram/windowRam/ram

#mem save -o ./CNN/RAMs/Pool_S_1L1F3/cnnOutput.mem -f mti -data binary -addr hex -startaddress 3872 -endaddress 8191 -wordsperline 1 /cnnwithram/windowRam/ram
