...
run
mem load -i ./CNN/RAMs/CurrentRunning/Conv_S_1L2F5/windowRAM.mem -format mti /cnnwithram/windowRam/ram 
mem load -i ./CNN/RAMs/CurrentRunning/Conv_S_1L2F5/weightsRAM.mem -format mti /cnnwithram/weightsRam/ram 
...
mai mem save -o ./CNN/RAMs/CurrentRunning/Conv_S_1L2F5/cnnOutput.mem -f mti -data binary -addr hex -wordsperline 1 /cnnwithram/windowRam/ram 
