...
run
mem load -i ./CNN/RAMs/CurrentRunning/Conv_L_1L2F3/windowRAM.mem -format mti /cnnwithram/windowRam/ram 
mem load -i ./CNN/RAMs/CurrentRunning/Conv_L_1L2F3/weightsRAM.mem -format mti /cnnwithram/weightsRam/ram 
...
mai mem save -o ./CNN/RAMs/CurrentRunning/Conv_L_1L2F3/cnnOutput.mem -f mti -data binary -addr hex -wordsperline 1 /cnnwithram/windowRam/ram 
