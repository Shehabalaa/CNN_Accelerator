...
force -freeze sim:/cnnwithram2/clk 0 0, 1 {5000 ps} -r {10 ns}
force -freeze sim:/cnnwithram2/rst 1 0
force -freeze sim:/cnnwithram2/start 0 0

run

mem load -i ./CNN/RAMs/CurrentRunning/Conv_S_2L_5F_2F/windowRAM.mem -format mti /cnnwithram2/windowRam/ram 
mem load -i ./CNN/RAMs/CurrentRunning/Conv_S_2L_5F_2F/weightsRAM.mem -format mti /cnnwithram2/weightsRam/ram 
...
mai mem save -o ./CNN/RAMs/CurrentRunning/Conv_S_2L_5F_2F/cnnOutput.mem -f mti -data binary -addr hex -wordsperline 1 /cnnwithram/windowRam/ram 
