...
mem load -i ../RAMs/CurrentRunning/Conv_S_2L1F51F5/windowRAM.mem -format mti /cnnwithram/windowRam/ram 
mem load -i ../RAMs/CurrentRunning/Conv_S_2L1F51F5/weightsRAM.mem -format mti /cnnwithram/weightsRam/ram 
...
mai mem save -o ../RAMs/CurrentRunning/Conv_S_2L1F51F5/cnnOutput.mem -f mti -data binary -addr hex -wordsperline 1 /cnnwithram/windowRam/ram 
